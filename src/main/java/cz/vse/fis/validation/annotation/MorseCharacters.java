...
/**
 * Morse alphabet characters validation annotation
 * 
...
@Documented
public @interface MorseCharacters {

	String message() default "The input must contain only dots, dashes, spaces and slashes.";
